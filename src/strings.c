...
__string__ String_Mins		[] = { 0xA8, 0x8A, 0x8F, 0x94, 0 };
...
__string__ String_Timer 	[] = { 0xAF, 0x8a, 0x8e, 0x86, 0x93, 0 };
__string__ String_TimerLength 	[] = { 0xAF, 0x8a, 0x8e, 0x86, 0x93, 0xBD, 0xA7, 0x86, 0x8F, 0x88, 0x95, 
0x89, 
0 };
